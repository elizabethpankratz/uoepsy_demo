...
`rating` looks like numbers, and R treats it like numbers.

And we can manipulate it like numbers.
...
But it's common practice to compare these *t*-values to a standard normal distribution, like *z*-scores.
